...
class CommsController::ShowTest < ActionController::TestCase

  test "show comm with unauthorized" do
    params={"id"=>"17"}
  ...
  test "show comm with success response" do
    params={ "id"=>"17"}
