require 'rest-client'
# The Class used for getting Creating Comm for corresponding User of EDO
#
# @rest_return Comm [Object] Comm Object with details
# @rest_return error_message [String] A message returned when Comm creation failed
class Comms::CreateComm
  include ExtendedInteractor

  # Call method used for creating the Comm associated with the User provided
  # Calls Comms Service to create Comm
  #
  # @rest_param params [Object] The parameters used for Comm creation
  # @rest_param current_user [User] The User whose comms need to be created
  #
  # @rest_return Comm [Object] Comm Object  with details
  # @rest_return error_message [String] A message returned when Comm creation fails
  def call
    after_check do
      ...
      begin
        response = RestClient.post(
          SystemConfig.get('comm/host') + '/comms',
          {
            comm: {
        ...
        context.fail!(message: 'comms.create_error')
      end
    end
  end

  # Checks for comms params and current user prior to comms creation
  #
